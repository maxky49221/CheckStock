...
public class UserQueryModel {
    ...
    public User insertNewUser(String username, String password , String email, String shopname) throws SQLException {
        try {
            con = DBConnection.getMySQLConnection();
            PreparedStatement preparedStatement = con.prepareStatement("INSERT INTO users (username, password , email , shop) VALUE (?, ?, ?,?);");
            preparedStatement.setString(1, username);
            preparedStatement.setString(2, password);
            preparedStatement.setString(3,email);
            preparedStatement.setString(4,shopname);
